...
$result = updateInterestRequestStatus($requestId, $id, "accepted");

if($result === "accepted"){
  setFlashMessage("success", "Interest request accepted. Chat is now enabled.");
} elseif($result === "already_processed"){
  setFlashMessage("danger", "This request has already been processed.");
} elseif($result === "not_found"){
  setFlashMessage("danger", "Request not found or you are not allowed to accept it.");
} else {
  setFlashMessage("danger", "Unable to accept this request.");
}
